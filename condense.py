import json
from readin import View, get_annotations
...
for bird_id in range(1,16):
  for view, song_entries in song_annotations[bird_id].items():
    for song_entry in song_entries:
      json_obj = {
        ...
        'xy': [],
        'av': {'1': f'{bird_id} {song_entry.song_type.value}'}
      }
